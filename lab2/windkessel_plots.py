...
if __name__ == '__main__':
    ...
    min_one_el = min(one_element_avg[:, 1])*np.ones(len(one_element_avg))
    ...
    plt.title('One-Element Experiment', fontsize=24)
    plt.xlabel('Time (s)', fontsize=16)
    plt.ylabel('Voltage (mV)', fontsize=16)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    ...
    plt.title('Two-Element Experiment', fontsize=24)
    plt.xlabel('Time (s)', fontsize=16)
    plt.ylabel('Voltage (mV)', fontsize=16)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    ...
    plt.title('One-Element Simulation Integral', fontsize=24)
    plt.xlabel('Time (s)', fontsize=16)
    plt.ylabel('Voltage (mV)', fontsize=16)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    ...
    plt.title('Two-Element Simulation Integral', fontsize=24)
    plt.xlabel('Time (s)', fontsize=16)
    plt.ylabel('Voltage (mV)', fontsize=16)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    ...
    # plt.figure()
    # plt.plot(sim_df.t1, sim_df.y1, lw=3, color='blue')
    # plt.plot(sim_df.t2, sim_df.y2, lw=3, color='red')
    # plt.show()
    
    plt.show()
    # print(one_sim_integral, two_sim_integral)
